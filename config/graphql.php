...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                // ExampleQuery::class,
                'countries' => App\GraphQL\Query\Country\CountryQuery::class,
                'country' => App\GraphQL\Query\Country\CountryResourceQuery::class,
                'user' => App\GraphQL\Query\User\UserResourceQuery::class,
    ...
    'types' => [
        ...
        'signup' => App\GraphQL\Types\SignupType::class,

        // input types
        'signupInput' => App\GraphQL\Inputs\SignupInput::class,
